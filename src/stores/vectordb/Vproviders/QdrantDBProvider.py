...
from src.stores.vectordb.VectorDBEnum import DistanceMethodEnums
import logging
...
class QdrantDBProvider(VectorDBInterface):
    ...
    async def insert_one(self, collection_name: str, text: str, vector: list
        ...
        if not self.is_collection_exist(collection_name):
            self.logger.error(f"can not insert into collection to non-exist collection {collection_name}")
            return False
        try:
